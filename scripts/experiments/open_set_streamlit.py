...
# Import your existing core logic from the updated backend script
# Ensure your backend file is named 'scripts/open_set.py'
...
def sample_row_for_random(
    ...
    for _ in range(MAX_DEBUG_SAMPLE_TRIES):
        ...
        # FIX: Unpack 5 values here to avoid crash
        model_label, _, _, _, _ = compute_open_set_for_row(
            rf,
            family_clf,
            family_le,
            row,
...
def main():
    ...
    st.write(
        "Interactive wrapper around your `open_set.py` pipeline:\n"
